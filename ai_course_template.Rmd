...
ottrpal::borrow_chapter(doc_path = "chunks/aboutCourse.md",
                        ...
                        "{COURSE_CATEGORY}" = grab_data(course_info, which_main_course, "Category", pastequotes = FALSE), "{COURSE_LAUNCH}" = grab_data(course_info, params$row_number, "launch_date", pastequotes = FALSE)))
```
