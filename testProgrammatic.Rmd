...
for (i in 1:nrow(full_repo_df)){
  ...
  if (courseOI != "AI for Decision Makers"){
    rmarkdown::render("single_course_template.Rmd", output = paste0(full_repo_df$name[i], "_coursePage.html"), params = list(course_name = courseOI, row_number = i))
  } else{
    rmarkdown::render("ai_course_template.Rmd", output = "AI_for_Decision_Makers_coursePage.html")
  }
}
```
