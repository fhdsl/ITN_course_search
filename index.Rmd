...
output_table <- setup_table(output_prep, "Type in key words to find courses relevant for you. Click on filter arrows to sort.",
                            columnDefsListOfLists = list(list(className = 'dt-center', targets = c(0,1,2,4)), #Title, Funding, Audience, Category
                                                         ...
                                                         list(width = "80px", targets = c(2)), # Audience
                                                         list(width = "65px", targets = c(4)), # Category
                                                         list(width = "145px", targets = c(5)) # Concepts
                                                        )
                            ) %>%
                            DT::formatStyle(columns = c(2,4), fontSize = '8pt') #specify text size for image name in Audience and category columns hopefully
```
...
<!-- | :----------------: | :------: | :-------: | :-----------: | :------------:|-->
<!-- | Course Name        | 0        | Center    | Not Specified | 12            |-->
<!-- | Funding            | 1        | Center    | 80px          | Not Specified |-->
<!-- | Broad Audience     | 2        | Center    | 80px          | 8             |-->
<!-- | Description        | 3        | Left      | 190px         | Not Specified |-->
<!-- | Category           | 4        | Center    | 65px          | 8             |-->
