...
modality_df <- read_sheet("https://docs.google.com/spreadsheets/d/1Dol8d16WF4see4JjGwt-ODj7QzRAuDeYixufNpxtWlM/edit?usp=sharing", range = "A:C")
...
output_table <- setup_table(output_prep, "Type in key words to find courses relevant for you. Click on filter arrows to sort.",
                            columnDefsListOfLists = list(list(className = 'dt-center', targets = c(0,1,2, 5)), #Course Name, Funding, Audience, More Resources
