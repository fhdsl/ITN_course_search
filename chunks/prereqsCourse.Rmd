...
if (str_detect({GITHUB_LINK}, pattern = "Adv_Reproducibility")){
  cat('<span style="font-size:18.0pt">Please check out our [Introduction to Reproducibility Course](https://jhudatascience.org/Reproducibility_in_Cancer_Informatics).</span>')
}
